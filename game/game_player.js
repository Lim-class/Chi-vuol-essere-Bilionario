...
function searchNewJobOffer() {
    ...
    if (availableJobs.length > 0) {
        ...
        // Aggiungiamo un listener per ripristinarlo quando il modale si chiude
...
// Nuova funzione helper per accettare il lavoro scelto
window.acceptJobOffer = function(jobTitle) {
    ...
    if (selectedJob) {
        ...
        showToast("Lavoro Accettato", `Hai iniziato la tua nuova carriera come ${selectedJob.title}!`, "success");
    }
};
