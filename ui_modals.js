...
function showMessage(title, message) {
    ...
    document.getElementById('message-text').innerHTML = message; // Modificato per supportare HTML
}
...
function showDecisionPrompt(title, message, onProceed, onDecline) {
    ...
    document.getElementById('decision-text').innerHTML = message; // Modificato per supportare HTML
